    ...
    <div className="min-h-16 bg-background border-b-2 border-border px-2 sm:px-4 py-2 sm:py-0 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 sm:gap-4">
      ...
      <div className="flex items-center gap-1.5 sm:gap-2 w-full sm:w-auto justify-end">
        ...
        <Button
          ...
          onClick={onPublish}
          disabled={isSaving}
          className={`border-2 border-border shadow-[2px_2px_0px_0px_hsl(var(--border))] hover:shadow-[3px_3px_0px_0px_hsl(var(--border))] hover:-translate-x-px hover:-translate-y-px transition-all touch-manipulation text-xs sm:text-sm ${storyStack.isPublished
