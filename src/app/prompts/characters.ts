 ...
 * Prompt options for character image generation
...
export const ARCHETYPE_OPTIONS: PromptOption[] = [
  {
    id: 'knight',
    label: 'Knight',
...
export const POSE_OPTIONS: PromptOption[] = [
  {
    id: 'heroic-stance',
    label: 'Heroic Stance',
...
export const AVATAR_STYLES: PromptOption[] = [
  {
    id: 'pixel',
    label: 'Pixel Art',
    ...
    icon: '👾',
    prompt: `16-bit pixel art style RPG character portrait. Square frame, limited color palette, clean pixelated edges. Classic SNES/GBA era aesthetic. Small detailed sprite suitable for game UI.`,
  },
  {
    id: 'chibi',
    label: 'Chibi',
    description: 'Cute anime-inspired',
    tags: ['cute', 'anime', 'chibi'],
    icon: '🎀',
    prompt: `Chibi style character portrait with exaggerated cute proportions. Large expressive head, small body. Soft rounded features, bright colors. Anime-inspired with friendly appeal.`,
  },
  {
    id: 'portrait',
    label: 'Portrait',
    description: 'Detailed painted bust',
    tags: ['detailed', 'painted', 'realistic'],
    icon: '🖼️',
    prompt: `Detailed character portrait bust, shoulders and head only. Painterly illustrated style with rich details. Focus on face and expression. Dramatic lighting, professional quality.`,
  },
  {
    id: 'icon',
    label: 'Icon',
    description: 'Simple minimalist badge',
    tags: ['minimal', 'icon', 'badge'],
    icon: '🔷',
    prompt: `Minimalist character icon design. Simplified geometric shapes, bold outlines. Limited color palette, easily recognizable silhouette. Suitable for UI elements and badges.`,
  },
];

export const characterDimensionOptions: Record<CharacterDimension, PromptOption[]> = {
