...
/**
 * Checkbox component with 44px minimum touch target for WCAG accessibility.
 * Uses invisible padding technique: 44px hit area with compact 16px visual.
 */
...
>(({ className, "data-testid": testId, ...props }, ref) => (
  // Wrapper provides 44px touch target while keeping checkbox visual compact
  <div className="relative inline-flex items-center justify-center min-h-11 min-w-11 touch-manipulation">
