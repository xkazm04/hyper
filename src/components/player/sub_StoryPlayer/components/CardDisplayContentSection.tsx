...
export function ContentSection({
  ...
  return (
    <div className="relative flex flex-col p-5 sm:p-8 md:p-10">
      ...
      <div className="absolute top-3 left-3 w-6 h-6 border-l-2 border-t-2 border-primary/20 rounded-tl-sm" />
      <div className="absolute top-3 right-3 w-6 h-6 border-r-2 border-t-2 border-primary/20 rounded-tr-sm" />
      <div className="absolute bottom-3 left-3 w-6 h-6 border-l-2 border-b-2 border-primary/20 rounded-bl-sm" />
      <div className="absolute bottom-3 right-3 w-6 h-6 border-r-2 border-b-2 border-primary/20 rounded-br-sm" />

      {/* Title - elegant display typography */}
      <h1
        className={cn(
          'font-bold mb-4 text-center leading-tight tracking-tight',
      ...
      {content && (
        ...
        >
          <p className={cn(
            ...
            // Elegant first letter styling
            'first-letter:text-2xl first-letter:font-bold first-letter:text-foreground first-letter:mr-0.5'
          )}>
      ...
      {(choices.length > 0 || !content) && (
        <div className="flex items-center justify-center gap-2 mb-6">
          <div className="h-px flex-1 max-w-16 bg-gradient-to-r from-transparent to-border/50" />
          ...
          <div className="h-px flex-1 max-w-16 bg-gradient-to-l from-transparent to-border/50" />
        </div>
      )}
