// Graph node definitions - Categories and pre-defined node type definitions

import type { NodeDefinition, ScriptNode } from './base'
...
export const NODE_DEFINITIONS: Record<string, NodeDefinition> = {
  ...
  goToCard: {
    ...
    compile: (node: ScriptNode, inputs: Record<string, string>) => `goToCard(${inputs.cardId || "'CARD_ID'"})`,
  },
  ...
  updateElement: {
    ...
    compile: (node: ScriptNode, inputs: Record<string, string>) => {
  ...
  hideElement: {
    ...
    compile: (node: ScriptNode, inputs: Record<string, string>) => `hideElement(${inputs.elementId})`,
  },
  ...
  showElement: {
    ...
    compile: (node: ScriptNode, inputs: Record<string, string>) => `showElement(${inputs.elementId})`,
  },
  ...
  showMessage: {
    ...
    compile: (node: ScriptNode, inputs: Record<string, string>) => `showMessage(${inputs.message})`,
  },
  ...
  playSound: {
    ...
    compile: (node: ScriptNode, inputs: Record<string, string>) => `playSound(${inputs.url})`,
  },
  ...
  getVariable: {
    ...
    compile: (node: ScriptNode, inputs: Record<string, string>) => `getVariable(${inputs.key})`,
  },
  ...
  setVariable: {
    ...
    compile: (node: ScriptNode, inputs: Record<string, string>) => `setVariable(${inputs.key}, ${inputs.value})`,
  },
  ...
  stringConstant: {
    ...
    compile: (node: ScriptNode) => `"${node.data.properties?.value || ''}"`,
  },
  ...
  numberConstant: {
    ...
    compile: (node: ScriptNode) => String(node.data.properties?.value || 0),
  },
  ...
  booleanConstant: {
    ...
    compile: (node: ScriptNode) => String(node.data.properties?.value || false),
  },
  ...
  stringConcat: {
    ...
    compile: (node: ScriptNode, inputs: Record<string, string>) => `(${inputs.a} + ${inputs.b})`,
  },
  ...
  userInput: {
    ...
    compile: (node: ScriptNode, inputs: Record<string, string>) => `prompt(${inputs.message})`,
  },
}
